...
const LetterAnimation = ({ children, index }: { children: React.ReactNode; index: number }) => {
  return (
    <motion.span
      initial={{ opacity: 0, y: 50 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{
        duration: 0.6, // Adjusted duration to ensure smoother animation
        delay: index * 0.1,
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="container mx-auto max-w-7xl px-6 relative py-12 md:py-24 overflow-hidden min-h-[90vh] flex items-center">
        <HeroScene />
        <motion.div
          style={{ y, opacity }}
          className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center justify-center relative z-10 w-full"
        >
          ...
          >
            ...
            <motion.h1
              ref={nameRef}
              className="font-playfair text-6xl md:text-8xl font-bold text-shimmer relative"
              initial="hidden"
      ...
      {/* About Section */}
      <section id="about" className="py-20 gradient-bg-subtle">
        <div className="container">
          <AnimatedSection className="flex flex-col items-center mb-12">
            <div className="highlight-gradient"></div>
            <h2 className="font-playfair text-4xl md:text-5xl font-bold text-center gradient-text">About Me</h2>
          </AnimatedSection>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <AnimatedSection delay={0.2}>
              ...
              >
                <Image
                  ...
                  height={1000}
                  alt="App Mockup"
                  className="shadow-none drop-shadow-lg"
                  priority
                />
              </motion.div>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.4}>
              <div className="relative">
                <div className="relative z-10 p-8 glass-card rounded-xl">
      ...
      {/* Skills Section */}
      <section id="skills" className="py-20 mesh-bg">
        <div className="container">
          <AnimatedSection className="flex flex-col items-center mb-12">
            <div className="highlight-gradient"></div>
            <h2 className="font-playfair text-4xl md:text-5xl font-bold text-center gradient-text">My Skills</h2>
          </AnimatedSection>
      ...
      <section id="projects" className="py-20 gradient-bg-subtle">
        <div className="container">
          <AnimatedSection className="flex flex-col items-center mb-12">
            <div className="highlight-gradient"></div>
            <h2 className="font-playfair text-4xl md:text-5xl font-bold text-center gradient-text">
              Featured Projects
            </h2>
          </AnimatedSection>
      ...
      <section id="testimonials" className="py-20 mesh-bg">
        <div className="container">
          <AnimatedSection className="flex flex-col items-center mb-12">
            <div className="highlight-gradient"></div>
            <h2 className="font-playfair text-4xl md:text-5xl font-bold text-center gradient-text">Testimonials</h2>
          </AnimatedSection>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <AnimatedSection delay={0.2}>
              <Card3D className="glass-card p-8 rounded-2xl shadow-lg">
      ...
      <section id="contact" className="py-20 gradient-bg-subtle">
        <div className="container">
          <AnimatedSection className="flex flex-col items-center mb-6">
            <div className="highlight-gradient"></div>
            <h2 className="font-playfair text-4xl md:text-5xl font-bold text-center gradient-text">Get In Touch</h2>
          </AnimatedSection>
          ...
          <div className="max-w-2xl mx-auto">
            <AnimatedSection delay={0.2}>
              <Card3D className="glass-card p-8 rounded-2xl shadow-lg" disableEffect={true}>
                <ContactForm />
              </Card3D>
            </AnimatedSection>
          </div>
